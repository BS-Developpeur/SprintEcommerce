...
<body>
   ...
   {?>
                <li> <a href="#"><span class="iconify" data-inline="false" data-icon="gridicons:product-external" style="color: blue; font-size: 16px;" data-flip="horizontal"></span>commandes</a>
                    ...
                    <ul>
                        ...
                        <li><a href="admine.php?page=insertionCommande">ajout une commande existante</a></li>
   ...
   {?>
            ...
            <a href="ajoutUtilisateur.php">sinscrire</a>
            <?php }?>
        ...
        <nav aria-label="infolettre">
            <div class="contact">
                ...
                <figure>
                    ...
                    <span><a href="">contact@lespiedsdansleau.org</a></span>
