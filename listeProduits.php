...
SELECT  concat( P.produit_id) as produit_id,concat( P.produit_libelle) as produit_libelle , concat(P.produit_description)as produit_description , concat(P.produit_prix)as produit_prix  ,concat(P.produit_quantite) as produit_quantite  ,concat(P.produit_commentaire) as produit_commentaire  ,concat(C.categorie_libelle) as categorie_libelle ,COUNT(fk_produit_id) as nb   FROM produits as P 

LEFT join categories as C ON P.fk_categorie_id = C.categorie_id

LEFT JOIN produits_commandes AS PC ON P.produit_id =PC.fk_produit_id
...
<body>
    ...
    <p>Seule les produits qui ne sont pas commande  doivent etre  supprimer</p>
